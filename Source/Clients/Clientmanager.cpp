...
void Clientconnection::Eventhandler1(struct mg_connection *Connection, int EventID, void *Eventdata)
{
    // Client connections and objects per instance.
    static std::mutex Mapguard;
    static std::unordered_map<mg_connection *, std::shared_ptr<Ayriaclient>> Clientmap;
...
void Clientconnection::Eventhandler2(struct mg_connection *Connection, int EventID, void *Eventdata)
{
    // Client connections and objects per instance.
    static std::mutex Mapguard;
    static std::unordered_map<mg_connection *, std::shared_ptr<Ayriaclient>> Clientmap;
...
void Clientconnection::Eventhandler3(struct mg_connection *Connection, int EventID, void *Eventdata)
{
    // Client connections and objects per instance.
    static std::mutex Mapguard;
    static std::unordered_map<mg_connection *, std::shared_ptr<Ayriaclient>> Clientmap;
...
void Clientconnection::Eventhandler4(struct mg_connection *Connection, int EventID, void *Eventdata)
{
    // Client connections and objects per instance.
    static std::mutex Mapguard;
    static std::unordered_map<mg_connection *, std::shared_ptr<Ayriaclient>> Clientmap;
...
void Clientconnection::Eventhandler5(struct mg_connection *Connection, int EventID, void *Eventdata)
{
    // Client connections and objects per instance.
    static std::mutex Mapguard;
    static std::unordered_map<mg_connection *, std::shared_ptr<Ayriaclient>> Clientmap;
